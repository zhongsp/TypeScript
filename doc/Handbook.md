...
### <a name="3.3"></a>公共，私有与受保护的修饰符

#### <a name="3.3.1"></a>默认为公有
...
我们把对fullName的直接访问改成了可以检查密码的`set`方法。我们也加了一个`get`方法，让上面的例子仍然可以工作。
